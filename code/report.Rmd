...
imp_multiple <- mice(main_data, m = 5, print = FALSE)
...
comp_df <- data.frame(
  ...
  Residual_Deviance = c(RD(fit_lw), RD(fit_mi))
)

show_table(comp_df, caption = "Model fit statistics", scale = FALSE)
```

```{r varprep, echo = FALSE}
