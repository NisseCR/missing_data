...
Table \@ref(tab:vars-desc) lists the variables used in the subset selection, which were utilized for the model in question. The table for the "full" dataset can be found in the Appendix [number]. 
...
```{r, full-vars-desc, echo = FALSE, eval = FALSE}
# TODO .csv file is missing!
