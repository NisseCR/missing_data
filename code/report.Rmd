...
Multiple imputation is the most academically acclaimed method to treat missing data, however, this paper only utilized it in its most default version. Other imputation methods with potential for better results were not explored. 

However, the alternatives might not be better options. 
