...
After arriving at the subset dataset, as Exploratory Data Analysis was performed. The distributions of the variables were investigated and presence of missing data was found. The important findings of this step are presented in 'EDA Results' section. It is important to note, that after the uneven distribution in 'marital' categories was discovered and the relationship of the categories with other variables was investigated, it was decided to combine the not-married categories into one. Thus, a less complex, binary variable was created. 

Following the EDA, the missing data problem was addressed. The extend, distribution and patterns of missingness were investigated.
